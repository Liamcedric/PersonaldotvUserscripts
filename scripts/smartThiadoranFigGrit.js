/**
 * Author: infinity
 * Name: Thidorian Fig Grit Auto
 * Description: Automatically uses Lesser Grit pots for you.
 */

if (JSON.parse(localStorage.getItem("scriptSettings"))?.smartThiadoranFigGrit) main();
...
async function usePot() {
	...
	await fetch(
		"https://api.dragonsofthevoid.com/api/usable/consume/u.thiadoran-fig",
